...
// employ page
    app.get("/employ",requireAuth ,function (req, res) {
        employmodel.find()
            .then(function (items) {
                res.render("employ", {
                    items
...
// employ single page
    ...
    // });
// adding employ
    app.get("/addemploy", function (req, res) {
...
//employ adding
    app.post('/addemploy/add', imageupload.single('image'), function (req, res) {
            var items = {
...
// updating employ
    app.post('/update/:id', imageupload.single('image'), (req, res) => {
        let id = req.params.id;
        let new_image = "";
        if (req.file){
